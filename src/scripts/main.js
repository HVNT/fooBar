...
angular.module('FooBar', [])
    .controller('FooBarCtrl', function ($scope, Player, PlayerUtilities) {

        /* global mappings */
        var CollegeConferenceMap = PlayerUtilities.collegeConferenceMap;
        var ConferenceMap = PlayerUtilities.conferenceMap;
        ...
        function getPositionsAndWeights() {
